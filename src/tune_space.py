...
def expand_row_col_meta_mode(mode: str) -> Dict[str, bool]:
    ...
    return {
        "none":       {"use_row_col_meta": False, "use_meta_mesh": False, "use_meta_row_col_edges": False},
        "basic":      {"use_row_col_meta": True,  "use_meta_mesh": False, "use_meta_row_col_edges": False},
        "with_mesh":  {"use_row_col_meta": True,  "use_meta_mesh": True,  "use_meta_row_col_edges": False},
        "with_cross": {"use_row_col_meta": True,  "use_meta_mesh": False, "use_meta_row_col_edges": True},
        "full":       {"use_row_col_meta": True,  "use_meta_mesh": True,  "use_meta_row_col_edges": True},
    }[mode]

def expand_verification_mode(mode: str, row_col_mode: str) -> Dict[str, bool]:
    """Expand verification mode with graceful degradation if row/col nodes are absent."""
    effective_mode = mode
