...
def compute_crossing_loss(
    ...
    """
    Enforces bridge crossing constraints.
...
def compute_verification_loss(
    ...
    -------
        ...
        balanced_acc: Balanced verification accuracy
            (average of positive and negative recall)
...
def compute_combined_loss(
    ...
    Returns
    -------
        dict: Contains 'total', 'ce', 'degree', 'crossing', 'verify',
              'verify_acc' values
    """
    ...
    loss_ce = functional.cross_entropy(logits_original, targets, reduction="mean")
...
def compute_ar_loss(
    ...
    msg = f"Unknown head_type: {head_type}"
    raise ValueError(msg)
