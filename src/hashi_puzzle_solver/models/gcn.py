...
class GCNEdgeClassifier(torch.nn.Module):
    ...
    def __init__(self, node_embedding_dim, hidden_channels, num_layers, dropout=0.25,
                 ...
                 use_conflict_status=True, use_meta_node=False, use_closeness_centrality=False,
                 use_articulation_points=False, use_spectral_features=False,
                 use_edge_features_in_prediction=False, edge_dim=3, **kwargs):
        """
        Args:
            ...
            use_closeness_centrality (bool): Whether to use closeness centrality. Default: False.
            ...
            use_edge_features_in_prediction (bool): Whether to concatenate edge features to prediction head. Default: False.
        ...
        # Edge prediction MLP
        # It takes concatenated features of two nodes (+ edge features if enabled)
    ...
    def forward(self, x, edge_index, edge_attr=None, **kwargs):
        ...
        Args:
            ...
            **kwargs: Additional arguments (e.g. batch) ignored by GCN.
        ...
        if self.use_edge_features_in_prediction and edge_attr is not None:
