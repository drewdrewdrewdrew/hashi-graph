...
class TestUpdateNodeFeatures:
    ...
    def test_update_unused_capacity(self) -> None:
        ...
        updated_x = update_node_features(
            x, current_bridges, edge_index, node_type, config,
        )
    ...
    def test_no_unused_capacity_feature(self) -> None:
        """Test function returns unchanged features when unused_capacity disabled."""
...
class TestApplyArAction:
    ...
    def test_max_bridges_limit(self) -> None:
...
class TestSelectArAction:
    ...
    def test_regression_head_selection(self) -> None:
    ...
    def test_conditional_head_selection(self) -> None:
    ...
    def test_no_valid_actions(self) -> None:
    ...
    def test_skip_no_op_actions(self) -> None:
