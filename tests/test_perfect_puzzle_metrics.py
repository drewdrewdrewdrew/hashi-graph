...
def test_perfect_puzzle_accuracy_all_correct() -> None:
...
def test_perfect_puzzle_accuracy_none_correct() -> None:
...
def test_perfect_puzzle_accuracy_partial() -> None:
...
def test_perfect_puzzle_accuracy_with_masking() -> None:
...
def test_calculate_batch_perfect_puzzles() -> None:
