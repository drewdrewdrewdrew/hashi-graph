...
from hashi_puzzle_solver.data import HashiDatasetCache, MakeBidirectional, GridStretch
...
class TestData(unittest.TestCase):
    ...
    def test_make_bidirectional(self) -> None:
        ...
        # [inv_dx, inv_dy, ...] - new schema has inv_dx, inv_dy at 0, 1
    ...
    def test_grid_stretch(self) -> None:
        ...
        with patch("torch.randint") as mock_randint:
            ...
            # Mock rand to ensure the transform triggers (rand <= prob)
